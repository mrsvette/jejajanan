 ...
 */
class VProductToCategory extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('product_id, category_id', 'safe'),
	 ...
	 * @return VProductToCategory the static model class
	 */
	...
	/**
	 * create new record for category product
