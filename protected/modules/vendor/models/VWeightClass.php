 ...
 */
class VWeightClass extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, unit, value', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VWeightClass the static model class
	 */
	...
	public function items($title = null)
	{
		...
		foreach($models as $model){
			$items[$model->id] = $model->title.' ('.$model->unit.')';
		}
		return $items;
	}
}
