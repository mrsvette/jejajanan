<?php $this->pageSection = 'Manufacture'; ?>
<?php
$this->breadcrumbs = array(
	ucfirst(Yii::app()->controller->module->id) => array('/'.Yii::app()->controller->module->id.'/'),
	Yii::t('VendorModule.vendor','Manufacture'),
);
?>
					...
					<div class="col-lg-8 col-lg-pull-4">
						<div class="btn-group">
							<button 
								...
								api-url="<?php echo Yii::app()->createUrl('/vendor/vManufacture/delete');?>" 
							...
							<button class="btn btn-default btn-sm" href="#new" data-toggle="tab">
								...
								<?php echo Yii::t('VendorModule.vendor','Create new manufacture');?>
							</button>
						</div>
					</div>
				</div>
