<?php $this->pageSection = 'Category'; ?>
<?php
$this->breadcrumbs = array(
	ucfirst(Yii::app()->controller->module->id) => array('/'.Yii::app()->controller->module->id.'/'),
	Yii::t('VendorModule.vendor','Category'),
);
?>
	...
	<div class="col-sm-12 col-md-12">
		<div class="panel panel-default">
					...
					<div class="col-lg-8 col-lg-pull-4">
						<div class="btn-group">
							<button 
								...
								api-url="<?php echo Yii::app()->createUrl('/vendor/vCategory/delete');?>" 
							...
							<button class="btn btn-default btn-sm" href="#new" data-toggle="tab">
								...
								<?php echo Yii::t('VendorModule.vendor','Create new category');?>
							</button>
						</div>
					</div>
				</div>
			...
			<!--<div class="panel-heading">
				<h4 class="panel-title"><?php echo Yii::t('global','Manage');?> <?php echo Yii::t('VendorModule.vendor','Category');?></h4>
			</div>-->
