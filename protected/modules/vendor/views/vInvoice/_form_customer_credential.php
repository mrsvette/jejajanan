...
<?php $form=$this->beginWidget('CActiveForm',array('id'=>'invoice-customer-form','htmlOptions'=>array('class'=>'form-horizontal'))); ?>

	<?php echo $form->errorSummary($model,null,null,array('class'=>'alert alert-warning alert-block alert-dismissable fade in')); ?>

	<h4><?php echo Yii::t('VendorModule.invoice','Client details at the moment of purchase');?></h4>
	...
	<div class="form-group">
		...
		<div class="col-md-4">
			<?php echo $form->dropDownList($model,'buyer_country',VCustomer::getCountries(),array('class'=>'form-control')); ?>
			...
			echo CHtml::ajaxSubmitButton(Yii::t('global', 'Update'),CHtml::normalizeUrl(array('vInvoice/update','id'=>$model->id)),array('dataType'=>'json','success'=>'js:
				function(data){
					if(data.status=="success"){
						$("#message-customer").html(data.div);
						$("#message-customer").parent().removeClass("hide");
						return false;
					}else{
						$("form[id=\'invoice-customer-form\']").parent().html(data.div);
					}
					return false;
				}'
			),
