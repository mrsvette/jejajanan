...
$this->breadcrumbs=array(
	...
	Yii::t('global','Manage').' '.Yii::t('MarketModule.invoice','Invoice'),
);
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo Yii::t('MarketModule.invoice','Invoice');?> #<?php echo $model->id;?></b></h4>
	</div>
	<div class="panel-body">
		<ul class="nav nav-tabs">
			<li class="active">
				<a data-toggle="tab" href="#general">
					<strong><?php echo Yii::t('MarketModule.invoice','Invoice Details');?></strong>
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#update">
					<strong><?php echo Yii::t('global','Manage').' '.Yii::t('MarketModule.invoice','Invoice');?></strong>
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#client">
					<strong><?php echo Yii::t('MarketModule.invoice','Client Credential');?></strong>
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#company">
					<strong><?php echo Yii::t('MarketModule.invoice','Company Credential');?></strong>
				</a>
			</li>
		</ul>
		<div class="tab-content">
			<div id="general" class="tab-pane row active">
				...
				<div class="col-sm-12">
				<?php //echo CHtml::link('<i class="fa fa-eye"></i> '.Yii::t('MarketModule.invoice','View As Client'),array('/invoice/view','id'=>$model->hash),array('class'=>'btn btn-default act-btn','title'=>'View As Client'));?>
				<?php if($model->status == ModInvoice::STATUS_PAID): ?>
					<?php echo CHtml::link('<i class="fa fa-ban"></i> '.Yii::t('MarketModule.invoice','Refund'),array('/market/invoices/refund','id'=>$model->id),array('class'=>'btn btn-default act-btn','title'=>'Refund'));?>
				<?php endif; ?>
				<?php if($model->status == ModInvoice::STATUS_UNPAID): ?>
					<?php echo CHtml::link('<i class="fa fa-play"></i> '.Yii::t('MarketModule.invoice','Mark As Paid'),array('/market/invoices/markAsPaid','id'=>$model->id),array('class'=>'btn btn-default act-btn','title'=>'Mark As Paid'));?>
					<?php echo CHtml::link('<i class="fa fa-envelope"></i> '.Yii::t('MarketModule.invoice','Send Reminder'),array('/market/invoices/sendReminder','id'=>$model->id),array('class'=>'btn btn-default act-btn','title'=>'Send Reminder'));?>
				<?php endif; ?>
				<?php echo CHtml::link('<i class="fa fa-trash-o"></i> '.Yii::t('global','Delete'),array('/market/invoices/delete','id'=>$model->id),array('class'=>'btn btn-default','onclick'=>'return hapus(this);'));?>
				</div>
			</div>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo Yii::t('MarketModule.invoice','Invoice Items');?></b></h4>
	</div>
	<div class="panel-body">
		<div class="table-responsive">
			...
			<table class="table table-bordered mb10">
				<tr>
					<th>&nbsp;</th>
					<th style="text-align:center;"><?php echo Yii::t('MarketModule.invoice','Item Name');?></th>
					<th style="text-align:center;"><?php echo Yii::t('MarketModule.invoice','Tax');?></th>
					<th style="text-align:center;"><?php echo Yii::t('MarketModule.invoice','Qty');?></th>
					<th style="text-align:center;"><?php echo Yii::t('MarketModule.invoice','Price');?></th>
					<th style="text-align:center;"><?php echo Yii::t('MarketModule.invoice','Total');?></th>
				</tr>
				...
				<?php else:?>
					<tr>
						...
						<td><?php echo CHtml::textField('title[]','',array('placeholder'=>Yii::t('MarketModule.invoice','New line description')));?></td>
						<td style="text-align:center;">-</td>
