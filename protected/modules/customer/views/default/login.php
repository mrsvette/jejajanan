...
$this->breadcrumbs = array(
	...
	Yii::t('CustomerModule.customer','Login'),
);
?>

<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
	<div class="rs_user_dashboard_tab_heading">
			<h4><?php echo Yii::t('CustomerModule.customer','Please enter your login detail');?></h4>
	</div>
	<div class="rs_user_dashboard_tab_info">
			...
			<div class="form-group">
				...
				<?php echo CHtml::link(Yii::t('CustomerModule.customer','Have a problem with your login account?'),'#',array('class'=>'request-password'));?>
				</span>
			</div>
